...
function App() {
  return (
    <main className="h-[1800px]">
      <h1 className="text-slate-300 text-4xl font-semibold text-center p-4 mb-4">
        Scroll to draw
      </h1>
      <section>
        <LineSVG />
      ...
      {/* <footer className="p-4">
        <span className="flex items-center justify-center text-slate-100">
          Made with
          <svg
          ...
          <a
            ...
            className="mx-1 text-slate-300 hover:text-slate-100 font-semibold"
          >
            @rmaximedev
          </a>
          ¬
